...
{
    public class GuiControllerV2 : MonoBehaviour
    {
        ...
        // For ending game UI
        public DominationConditionUI dominationConditionUI;
        ...
        private void OnTurnEnded(object sender, bool isNetworkInvoked)
        {
            ...
            dominationConditionUI.Result = (sender as CellGrid).CurrentPlayerNumber + 1;
        }
